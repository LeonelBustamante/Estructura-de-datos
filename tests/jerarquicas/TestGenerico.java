...
public class TestGenerico {
        ...
        public static void main(String args[]) {
                ...
                System.out.println(
                                "Busco el nivel de raiz. Tiene que dar " + sOk + " --> "
                ...
                System.out.println(
                                "Busco el nivel de 9. Tiene que dar " + sOk + " --> "
                ...
                System.out.println(
                                "Busco el nivel de 3. Tiene que dar " + sOk + " --> "
                ...
                System.out.println("\n");
                System.out.println(
                                "Inserto con padre inexistente. Tiene que dar " + sErr + " --> "
                ...
                System.out.println(
                                "Busco a 25 con pertenece. Tiene que dar " + sOk + " ---> "
                ...
                System.out.println("********************************\n");
                System.out.println(
                                "Busco al padre de 55. Tiene que dar " + sOk + " --> "
                                                + (((int) a.padre(55) == 30) ? sOk : sErr));
                System.out.println(
                                "Busco al padre de 20. Tiene que dar " + sOk + " --> "
                                                + (((int) a.padre(20) == 15) ? sOk : sErr));
                System.out.println(
                                "Busco al padre de raiz. Tiene que dar " + sOk + " --> "
                ...
                System.out.println(
                                "Busco a raiz con pertenece. Tiene que dar " + sOk + " ---> "
                                                + ((a.pertenece(10)) ? sOk : sErr));
                System.out.println(
                                "Busco a 55 con pertenece. Tiene que dar " + sOk + " ---> "
                                                + ((a.pertenece(55)) ? sOk : sErr));
                System.out
                                .println("Busco a 7 con pertenece. Tiene que dar " + sOk + " ---> "
                ...
                System.out
                                .println("Busco ancentros de elemento inexistente deberia dar vacio: "
                ...
                System.out.println(
                                "Busco el nivel de raiz. Tiene que dar 0: " + sOk + " --> "
                                                + (((int) a.nivel(10) == 0) ? sOk : sErr));
                System.out.println(
                                "Busco el nivel 3. Tiene que dar 2: " + sOk + " --> "
                                                + (((int) a.nivel(3) == 2) ? sOk : sErr));
                System.out.println(
                                "Busco el nivel 20. Tiene que dar 2: " + sOk + " --> "
                                                + (((int) a.nivel(20) == 2) ? sOk : sErr));
                System.out.println(
                                "Busco el nivel 9. Tiene que dar 1: " + sOk + " --> "
                                                + (((int) a.nivel(9) == 1) ? sOk : sErr));
                System.out.println(
                                "Busco el nivel 22. Tiene que dar 2: " + sOk + " --> "
                                                + (((int) a.nivel(22) == 2) ? sOk : sErr));
                System.out.println(
                                "Busco el nivel 45. Tiene que dar 3: " + sOk + " --> "
                                                + (((int) a.nivel(45) == 3) ? sOk : sErr));
                System.out.println(
                                "Busco el nivel 55. Tiene que dar 3: " + sOk + " --> "
                ...
                System.out.println(
                                "Grado de árbol completo: Tiene que dar 4: " + sOk + " --> "
