...
public class TestingLista {
    ...
    public static void testLista() {
        ...
        System.out.println("\t--> " + l1.toString());
        System.out.print(
                "Inserta 3 pos long+1 espera TRUE: \t\t" + ((l1.insertar(3, l1.longitud() + 1) == true) ? sOk : sErr));
        System.out.println("\t--> " + l1.toString());
        ...
        System.out.print("Inserta 10 pos long+2 espera FALSE: \t\t"
                + ((l1.insertar(10, l1.longitud() + 2) == false) ? sOk : sErr));
        System.out.println("\t--> " + l1.toString());

        int longi = l1.longitud();
        for (int i = -1; i <= longi + 2; i++) {
            if (i > 0 && i <= longi) {
                System.out.println("Recupera " + i + " \tespera " + i + " retorna " + l1.recuperar(i) + ":\t\t"
                        + (((int) l1.recuperar(i) == i) ? sOk : sErr));
            } else {
                System.out.println("Recupera " + i + " \tespera NULL retorna " + l1.recuperar(i) + ":\t"
                        + ((l1.recuperar(i) == null) ? sOk : sErr));
            }
        }
        ...
        for (int i = -1; i <= longi + 2; i++) {
            if (i > 0 && i <= longi) {
                System.out.println("Localiza " + i + " \tespera " + i + " retorna " + l1.localizar(i) + ":\t\t"
                        + ((l1.localizar(i) == i) ? sOk : sErr));
            } else {
                System.out.println("Localiza " + i + " \tespera -1 retorna " + l1.localizar(i) + ":\t\t"
                        + ((l1.localizar(i) == -1) ? sOk : sErr));
            }
        }
        ...
        System.out.println("\t--> " + l1.toString());
        System.out
                .print("Elimina ultimo espera TRUE y 2,3: \t\t" + ((l1.eliminar(l1.longitud()) == true) ? sOk : sErr));
        System.out.println("\t--> " + l1.toString());
        ...
        System.out.println("Inserta 10 pos 1 espera [10,2,9,3]: \t\t" + ((l1.insertar(10, 1) == true) ? sOk : sErr));
        l1.insertar(10, 1);
        l1.insertar(2, 1);
        l1.insertar(2, 1);
        ...
        System.out.println("////////////////////////////////////////////////////////////////////////////////////");
        System.out.println("////////////////////////////////////////////////////////////////////////////////////");
        System.out.println("obtenerMultiplos --> " + l1.obtenerMultiplos(2));
        ...
        while (!l1.esVacia()) {
            System.out
                    .print("Elimina cabecera varias veces hasta vaciar: \t" + ((l1.eliminar(1) == true) ? sOk : sErr));
            System.out.println("\t--> " + l1.toString());
        }
        ...
        System.out.println("Localiza 1 en vacia espera -1, retorna " + l1.localizar(1) + ": \t"
                + ((l1.localizar(1) == -1) ? sOk : sErr));
        ...
        System.out.println(
                "Inserta 90,ultimo espera true: \t\t\t" + ((l2.insertar(90, l2.longitud() + 1) == true) ? sOk : sErr));
